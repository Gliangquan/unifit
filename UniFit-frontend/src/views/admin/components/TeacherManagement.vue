  ...
  <div class="teacher-management">
    ...
    <a-card style="margin-bottom: 16px;">
      <a-space style="width: 100%; margin-bottom: 12px;">
        ...
        <a-button type="primary" @click="showAddTeacher">添加教师</a-button>
      </a-space>
    </a-card>
    ...
    <a-modal 
      ...
      :title="isAddMode ? '添加教师' : '编辑教师信息'" 
      @ok="submitEdit" 
      :confirm-loading="editLoading"
      width="600px"
    >
      <a-form :model="editForm" :label-col="{ span: 6 }" :wrapper-col="{ span: 18 }">
        <a-form-item label="账号" required v-if="isAddMode">
          <a-input 
        ...
        <a-form-item label="密码" required v-if="isAddMode">
          <a-input-password 
...
import { listUsers, getUserDetail, updateUser, updateUserStatus, deleteUser as deleteUserApi, createTeacher } from '../../../api';
...
const submitEdit = async () => {
  ...
  if (isAddMode.value && (!editForm.userAccount || !editForm.userPassword)) {
